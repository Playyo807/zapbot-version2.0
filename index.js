...
const client = new Client({ puppeteer:{
  headless: true,
  args: ['--no-sandbox', '--disable-setuid-sandbox', '--disable-web-security', 'granted-permissions=all', '--disable-features=IsolateOrigins,site-per-process', '--granted-permissions=all', '--write-permissions=all']
